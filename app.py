...
def index():
    if request.method == 'POST':
        ...
        #if reviews.count()>1: # if there is a collection with searched keyword and it has records in it
        ...
        prodRes = uReq(productLink) # getting the product page from serve
        prodRespage = prodRes.read()
        prodRes.close()
        prod_html = bs(prodRespage, "html.parser") # parsing the product page as HTML
